...
from pytorchvideo.models.hub.slowfast import slowfast_r501_detection
...
def main(config):
    ...
    for i in range(0,math.ceil(video.duration),1):
        ...
        print("pred1:", len(yolo_preds.pred))
        id_to_ava_labels={}
...
if __name__=="__main__":
    ...
    parser.add_argument('--input', type=str, default="陈李--一花一鸟总关情-00.02.28.000-00.08.57.000-00.00.49.467-00.01.00.944.mp4", help='test imgs folder or video or camera')
